class Stat:
    def get(self):  # sample data
        return {
            { 'player': 'Gamer1', 'time': '1289021', 'win': True, 'score': 1234, 'difficulty': 'easy', 'field': 'large' },
            { 'player': 'Gamer2', 'time': '432489', 'win': False, 'score': 32, 'difficulty': 'hard', 'field': 'medium' },
            { 'player': 'Gamer3', 'time': '328193', 'win': False, 'score': 154, 'difficulty': 'medium', 'field': 'small' },
            { 'player': 'Gamer2', 'time': '32382', 'win': True, 'score': 1234, 'difficulty': 'easy', 'field': 'small' },
            { 'player': 'Gamer1', 'time': '323128', 'win': True, 'score': 1234, 'difficulty': 'easy', 'field': 'large' },
        }
