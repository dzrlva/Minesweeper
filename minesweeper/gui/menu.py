...
class MainMenu:
    ...
    def __init__(self, app):
        ...
        self.buttonsConfig = [
            ...
            {"text": _("Quit"), "command": app.destroy},
        ]
        ...
        self.title = tk.Label(
            text="Minesweeper", font=app.font, **styles.COMMON_STYLE()
        )
...
class NewGameMenu:
    ...
    def __init__(self, app, username=""):
        ...
        self.title = tk.Label(
            app, text=_("New game"), font=app.font, **styles.COMMON_STYLE()
        )
        ...
        self.fsInpTitle = tk.Label(
            self.frame, text=_("Field size"), font=labelFont, **styles.COMMON_STYLE()
        )
        self.fsInpMenu = tk.OptionMenu(
            self.frame,
            self.curFieldSize,
            *list(self.fieldSizes.keys()),
        )
        ...
        self.difTitle = tk.Label(
            self.frame, text=_("Difficulty"), font=optionFont, **styles.COMMON_STYLE()
        )
        self.difficulties = [
            (_("easy"), "0.1"),
            (_("medium"), "0.2"),
...
class SettingsMenu:
    ...
    def __init__(self, app):
        ...
        self.resMenu = tk.OptionMenu(
            self.frame, self.curRes, *self.resOptions, command=self.onResChange
        )
        ...
        self.fsVar = tk.StringVar(
            self.frame, "1" if app.appOpts["fullscreen"] == "True" else "0"
        )
        self.fsLabel = tk.Label(
            self.frame, font=labelFont, text=_("Fullscreen"), **styles.COMMON_STYLE()
        )
        ...
        self.langMenu = tk.OptionMenu(
            self.frame, self.curLang, *self.langOptions, command=self.onLangChange
        )
